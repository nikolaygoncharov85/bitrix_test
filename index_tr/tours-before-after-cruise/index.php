...
if($_REQUEST['ELEMENT_ID'] && $_REQUEST['ELEMENT_ID']){
    ...
    LocalRedirect("/tours-before-after-cruise/".$element[CODE]."/");
}
?>
<?$APPLICATION->SetTitle("Туры до/после круиза");?>
<?
$APPLICATION->IncludeComponent(
	"bitrix:news",
	"tours-before-after-cruise",
	Array(
		"ADD_ELEMENT_CHAIN" => "N",
		...
		"CACHE_TYPE" => "A",
		"CHECK_DATES" => "Y",
		"COMPONENT_TEMPLATE" => "tours-before-after-cruise",
		...
		"FILTER_NAME" => "",
		"FILTER_PROPERTY_CODE" => array("CITY","COUNTRY","RESORT"),
		...
		"SEF_FOLDER" => "/tours-before-after-cruise/",
		"SEF_MODE" => "Y",
