...
$( "#slider-range" ).slider({
    ...
    slide: function( event, ui ) {
        ...
        $('input[name="form_text_254"]').val(ui.values[ 0 ]);
        $('input[name="form_text_255"]').val(ui.values[ 1 ]);
        //$( "#amount" ).val( "$" + ui.values[ 0 ] + " - $" + ui.values[ 1 ] );
    }
});
$('input[name="form_text_254"]').keyup(function(){
    $( "#slider-range" ).slider( "values", 0, $(this).val() );
});
$('input[name="form_text_255"]').keyup(function(){
