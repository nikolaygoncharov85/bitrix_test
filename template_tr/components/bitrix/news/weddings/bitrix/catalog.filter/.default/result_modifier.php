...
$arResult["ITEMS"]['PROPERTY_393']['INPUT'] = SelectBoxFromArray(
    $arResult["ITEMS"]['PROPERTY_393']['INPUT_NAME'],
    $arr,
...
$arResult["ITEMS"]['PROPERTY_394']['INPUT'] = SelectBoxFromArray(
    $arResult["ITEMS"]['PROPERTY_394']['INPUT_NAME'],
    $arr,
...
$arResult["ITEMS"]['PROPERTY_395']['INPUT'] = SelectBoxFromArray(
    $arResult["ITEMS"]['PROPERTY_395']['INPUT_NAME'],
    $arr,
