...
$APPLICATION->AddChainItem(
    ...
    '/weddings/?arrFilter_pf[COUNTRY]=' . $arResult['PROPERTIES']['COUNTRY']['VALUE'] . '&set_filter=Фильтр&set_filter=Y'
);

/*if ($arResult['PROPERTIES']['CITY']['VALUE'] > 0 && $arResult['PROPERTY_CITY']) {
    $APPLICATION->AddChainItem(
        strip_tags($arResult['PROPERTY_CITY']),
        '/weddings/?arrFilter_pf[COUNTRY]=' . $arResult['PROPERTIES']['COUNTRY']['VALUE'] . '&arrFilter_pf[CITY]=' . $arResult['PROPERTIES']['CITY']['VALUE'] . '&set_filter=Фильтр&set_filter=Y'
    );
}*/
