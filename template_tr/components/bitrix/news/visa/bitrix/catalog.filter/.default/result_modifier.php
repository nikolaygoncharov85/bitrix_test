...
$arResult["ITEMS"]['PROPERTY_264']['INPUT'] = SelectBoxFromArray(
    $arResult["ITEMS"]['PROPERTY_264']['INPUT_NAME'],
    $arr,
...
$arResult["ITEMS"]['PROPERTY_265']['INPUT'] = SelectBoxFromArray(
    $arResult["ITEMS"]['PROPERTY_265']['INPUT_NAME'],
    $arr,
