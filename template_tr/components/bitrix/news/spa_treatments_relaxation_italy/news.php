...
<script type="text/javascript">
    $(document).ready(function(){
        $("b.termal_table").click(function(){
           if($(this).hasClass('active')){
               $(this).removeClass('active');
               $("#termal_table").hide('swing');
           } else {
               $(this).addClass('active');
               $("#termal_table").show('swing');
           }
        });
    });
</script>
<div class="container without-padding">
    <div class="page" style="margin-bottom: 0 !important;">
        <div class="page-content" style="width: 100%!important;background: white;padding: 25px;>
			<div class="row-1 row-inner white-bg mb-col-dist" style="font-size: 14px;padding: 10px 20px;">
                <p>
                    В Италии насчитывается около 180 термальных источников. Здесь вам предложат и питьевой курс, и лечебные воды, гроты, и различные программы. Как выбрать то, что подойдет именно вам?  Ответ вы найдете в <b class="termal_table">таблице-справочнике</b>
                </p>
                <br>
                <table id="termal_table">
                    <tr>
                        <td></td>
                        <td>Абано и Монтегротто Терме</td>
                        <td>Монтекатини Терме</td>
                        <td>Терме Сирмионе</td>
                        <td>Искья Терме</td>
                        <td>Фьюджи</td>
                        <td>Кьянчано Терме</td>
                        <td>Монсумано Терме</td>
                        <td>Сан Джулиано Терме</td>
                        <td>Сан Кашиано Терме</td>
                    </tr>
                    <tr>
                        <td>Желудочно-кишечный тракт</td>
                        <td></td>
                        <td class="green"><a href="#montekatini_terme"></a></td>
                        <td></td>
                        <td></td>
                        <td class="green"><a href="#fyudzhi"></a></td>
                        <td class="green"><a href="#kyanchano_terme"></a></td>
                        <td></td>
                        <td></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td>Лор и дыхательная система</td>
                        <td class="green"><a href="#abano_montegrotto_terme"></a></td>
                        <td class="green"><a href="#montekatini_terme"></a></td>
                        <td class="green"><a href="#sirmione"></a></td>
                        <td></td>
                        <td></td>
                        <td class="green"><a href="#kyanchano_terme"></a></td>
                        <td class="green"><a href="#monsummano_terme"></a></td>
                        <td class="green"><a href="#san_dzhuliano_terme"></a></td>
                        <td class="green"><a href="#san_kashiana_terme"></a></td>
                    </tr>
                    <tr>
                        <td>Дерматология</td>
                        <td class="green"><a href="#abano_montegrotto_terme"></a></td>
                        <td class="green"><a href="#montekatini_terme"></a></td>
                        <td class="green"><a href="#sirmione"></a></td>
                        <td class="green"><a href="#iskya"></a></td>
                        <td></td>
                        <td></td>
                        <td class="green"><a href="#monsummano_terme"></a></td>
                        <td></td>
                    ...
                    <tr>
                        <td>Заболевания обмена веществ</td>
                        <td></td>
                        <td class="green"><a href="#montekatini_terme"></a></td>
                        <td class="green"><a href="#sirmione"></a></td>
                        <td class="green"><a href="#iskya"></a></td>
                    ...
                    <tr>
                        <td>Эстетические процедуры, программы омоложения</td>
                        <td class="green"><a href="#abano_montegrotto_terme"></a></td>
                        <td class="green"><a href="#montekatini_terme"></a></td>
                        <td class="green"><a href="#sirmione"></a></td>
                        <td class="green"><a href="#iskya"></a></td>
                    ...
                    <tr>
                        <td>Антистрессовая терапия, Синдром хронической усталости</td>
                        <td class="green"><a href="#abano_montegrotto_terme"></a></td>
                        <td class="green"><a href="#montekatini_terme"></a></td>
                        <td class="green"><a href="#sirmione"></a></td>
                        <td class="green"><a href="#iskya"></a></td>
