...
$arResult["ITEMS"]['PROPERTY_311']['INPUT'] = SelectBoxFromArray(
    $arResult["ITEMS"]['PROPERTY_311']['INPUT_NAME'],
    $arr,
...
$arResult["ITEMS"]['PROPERTY_312']['INPUT'] = SelectBoxFromArray(
    $arResult["ITEMS"]['PROPERTY_312']['INPUT_NAME'],
    $arr,
...
$arResult["ITEMS"]['PROPERTY_313']['INPUT'] = SelectBoxFromArray(
    $arResult["ITEMS"]['PROPERTY_313']['INPUT_NAME'],
    $arr,
