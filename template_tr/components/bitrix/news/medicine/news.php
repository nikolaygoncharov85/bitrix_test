        ...
        <div class="left-sidebar">
            ...
            if ($countryId > 0) {
                ...
                <ul class="left-sidebar-menu">
                    ...
                    $visaRes = CIBlockElement::GetList(array(), array('IBLOCK_ID' => 45, 'PROPERTY_COUNTRY' => $countryId, "ACTIVE" => 'Y'), false, false);
                    if ($arVisa = $visaRes->Fetch()) {?>
                        <li>
...
if ($_REQUEST['TYPE_SEA']) {
    $arrFilter['PROPERTY_TYPE_SEA'] = 172;
}

if ($_REQUEST['TYPE_ISRAEL']) {
    $arrFilter['PROPERTY_TYPE_ISRAEL'] = 173;
}
if ($_REQUEST['TYPE_RESORTS']) {
    $arrFilter['PROPERTY_TYPE_RESORTS'] = 174;
}
?>
