...
if($arCountry1[DEPTH_LEVEL]==2){
    ...
    $APPLICATION->AddChainItem(
        $arParent[NAME],
        '/tours-before-after-cruise/'.$arParent[CODE].'/'
    );
}
else {
...
<div class="container without-padding">
    <div class="page">
            ...
            <div class="left-sidebar-section">
                <div class="find-hotels">
                    <form class="find-hotels-form" method="get">
                        <input class="find-hotels-input" type="text" name="q" placeholder="Поиск по названию"/>
        ...
        if (!empty($_REQUEST['SID'])) {
            global $arrFilter;
            $arrFilter['PROPERTY_TOUR_SECTION'] = (int) $_REQUEST['SID'];
        }
        ?>
        <div class="page-content">
            ...
            ${$arParams[FILTER_NAME]}["!PROPERTY_show_archive"] = "Y";
            $APPLICATION->IncludeComponent(
