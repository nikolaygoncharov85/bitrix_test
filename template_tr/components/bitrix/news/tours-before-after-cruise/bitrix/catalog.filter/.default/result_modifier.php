...
$arResult["ITEMS"]['PROPERTY_667']['INPUT'] = SelectBoxFromArray(
    $arResult["ITEMS"]['PROPERTY_667']['INPUT_NAME'],
    $arr,
...
$arResult["ITEMS"]['PROPERTY_668']['INPUT'] = SelectBoxFromArray(
    $arResult["ITEMS"]['PROPERTY_668']['INPUT_NAME'],
    $arr,
...
$arResult["ITEMS"]['PROPERTY_669']['INPUT'] = SelectBoxFromArray(
    $arResult["ITEMS"]['PROPERTY_669']['INPUT_NAME'],
    $arr,
    $_REQUEST['arrFilter_pf']['CITY'],
    "",
    " class=\"custom-select\" data-placeholder=\"Место начала тура\"",
    false,
    "form2"
);
//----------------------------------------------------------------------//
