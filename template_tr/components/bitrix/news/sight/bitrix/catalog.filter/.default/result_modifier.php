...
$arResult["ITEMS"]['PROPERTY_180']['INPUT'] = SelectBoxFromArray(
    $arResult["ITEMS"]['PROPERTY_180']['INPUT_NAME'],
    $arr,
...
$arResult["ITEMS"]['PROPERTY_181']['INPUT'] = SelectBoxFromArray(
    $arResult["ITEMS"]['PROPERTY_181']['INPUT_NAME'],
    $arr,
