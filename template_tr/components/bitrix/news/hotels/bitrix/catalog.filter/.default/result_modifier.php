...
if (strlen($arParams['CODE']) > 0  && $arParams['PAGE'] == 'detail') {
    $rsElement = CIBlockElement::GetList(
        ...
        false,
        array('nTopCount' => 1),
        array('ID', 'NAME', 'IBLOCK_ID', 'PROPERTY_COUNTRY', 'PROPERTY_RESORT', 'PROPERTY_CITY')
    );

    if ($arElement = $rsElement->Fetch()) {
        
        $_REQUEST['arrFilter_pf']['COUNTRY'] = $arElement['PROPERTY_COUNTRY_VALUE'];
        $_REQUEST['arrFilter_pf']['RESORT'] = $arElement['PROPERTY_RESORT_VALUE'];
        $_REQUEST['arrFilter_pf']['CITY'] = $arElement['PROPERTY_CITY_VALUE'];
...
$arResult["ITEMS"]['PROPERTY_189']['INPUT'] = SelectBoxFromArray(
    $arResult["ITEMS"]['PROPERTY_189']['INPUT_NAME'],
    $arr,
...
$arResult["ITEMS"]['PROPERTY_307']['INPUT'] = SelectBoxFromArray(
    $arResult["ITEMS"]['PROPERTY_307']['INPUT_NAME'],
    $arr,
...
$arResult["ITEMS"]['PROPERTY_190']['INPUT'] = SelectBoxFromArray(
    $arResult["ITEMS"]['PROPERTY_190']['INPUT_NAME'],
    $arr,
