...
<div class="container without-padding">
    <div class="page">
        ...
        <div class="left-sidebar">
            ...
            <p class="left-sidebar-menu-title">Экскурсии</p>
            <ul class="left-sidebar-menu">
                <li>
            ...
            <!--<div class="left-sidebar-sep"></div>-->
            ...
            if ($countryId > 0) {
                $arCountry = CIblockSection::GetList(array(), array('IBLOCK_ID' => 27, 'ID' => $countryId), false, array("UF_NEW_YEAR", "UF_BOOKING_LINK", "UF_SKIING"))->Fetch();
...
if ($_REQUEST['TYPE_GROUP']) {
    $arrFilter['PROPERTY_TYPE_GROUP'] = 168;
}

if ($_REQUEST['TYPE_INDIVIDUAL']) {
    $arrFilter['PROPERTY_TYPE_INDIVIDUAL'] = 169;
}
?>
