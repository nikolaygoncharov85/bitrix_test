...
$arResult["ITEMS"]['PROPERTY_303']['INPUT'] = SelectBoxFromArray(
    $arResult["ITEMS"]['PROPERTY_303']['INPUT_NAME'],
    $arr,
...
$arResult["ITEMS"]['PROPERTY_304']['INPUT'] = SelectBoxFromArray(
    $arResult["ITEMS"]['PROPERTY_304']['INPUT_NAME'],
    $arr,
