...
$arResult["ITEMS"]['PROPERTY_240']['INPUT'] = SelectBoxFromArray(
    $arResult["ITEMS"]['PROPERTY_240']['INPUT_NAME'],
    $arr,
...
$arResult["ITEMS"]['PROPERTY_308']['INPUT'] = SelectBoxFromArray(
    $arResult["ITEMS"]['PROPERTY_308']['INPUT_NAME'],
    $arr,
