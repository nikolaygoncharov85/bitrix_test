...
$arResult["ITEMS"]['PROPERTY_177']['INPUT'] = SelectBoxFromArray(
    $arResult["ITEMS"]['PROPERTY_177']['INPUT_NAME'],
    $arr,
...
$arResult["ITEMS"]['PROPERTY_309']['INPUT'] = SelectBoxFromArray(
    $arResult["ITEMS"]['PROPERTY_309']['INPUT_NAME'],
    $arr,
...
$arResult["ITEMS"]['PROPERTY_178']['INPUT'] = SelectBoxFromArray(
    $arResult["ITEMS"]['PROPERTY_178']['INPUT_NAME'],
    $arr,
    $_REQUEST['arrFilter_pf']['CITY'],
    "",
    " class=\"custom-select\" data-placeholder=\"Экскурсии из\"",
    false,
    "form2"
);
//----------------------------------------------------------------------//
