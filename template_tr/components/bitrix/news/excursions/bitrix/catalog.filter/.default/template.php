...
?>
<form name="<? echo $arResult["FILTER_NAME"] . "_form" ?>" action="/excursions/" method="get">
    <?
...
<script>
    function getCityList(resortId) {
        ...
        else var data = {'countryId': <?=$_REQUEST[arrFilter_pf][COUNTRY]?>};
        $.ajax({
            dataType: 'html',
            type: "POST",
