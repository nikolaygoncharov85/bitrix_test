...
$obRes=CIBlockElement::GetList(array(),array("IBLOCK_ID"=>$arParams["IBLOCK_ID"],"IBLOCK_TYPE"=>$arParams["IBLOCK_TYPE"]),array("PROPERTY_COUNTRY"));
while($arCountries = $obRes->GetNext()){
    $arCountryIds[]=$arCountries[PROPERTY_COUNTRY_VALUE];
}

$res = CIBlockSection::GetList(array('NAME' => 'ASC'), array('IBLOCK_ID' => 27, 'ACTIVE' => 'Y', 'ID' => $arCountryIds), false);
...
//print_pre($arResult["ITEMS"]['PROPERTY_241']);
$arResult["ITEMS"]['PROPERTY_241']['INPUT'] = SelectBoxFromArray(
    $arResult["ITEMS"]['PROPERTY_241']['INPUT_NAME'],
    $arr,
...
$arResult["ITEMS"]['PROPERTY_242']['INPUT'] = SelectBoxFromArray(
    $arResult["ITEMS"]['PROPERTY_242']['INPUT_NAME'],
    $arr,
