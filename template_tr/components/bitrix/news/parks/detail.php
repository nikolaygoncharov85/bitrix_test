...
$arSelect = Array("ID", "NAME", "DETAIL_PAGE_URL", "PREVIEW_PICTURE", "PROPERTY_COUNTRY");
$arFilter = Array("IBLOCK_ID"=>64, "CODE"=>$arResult[VARIABLES][ELEMENT_CODE]);
$res = CIBlockElement::GetList(Array(), $arFilter, false, Array(), $arSelect);
$ob = $res->GetNextElement();
$arFields = $ob->GetFields();
$arProps = $ob->GetProperties();
$countryId = $arProps["COUNTRY"]["VALUE"];
?>
